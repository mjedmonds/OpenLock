...
from openlock.common import TwoDConfig, LeverConfig, LeverRoleEnum, ObjectPositionEnum, LOCK_REGEX_STR
...
LEVER_CONFIGS = {
    ...
    'trial1'   : [LeverConfig(ObjectPositionEnum.UPPERRIGHT, LeverRoleEnum.l0, None),
    ...
    'trial2'   : [LeverConfig(ObjectPositionEnum.UPPERRIGHT, LeverRoleEnum.inactive, None),
    ...
    'trial3'   : [LeverConfig(ObjectPositionEnum.UPPERRIGHT, LeverRoleEnum.inactive, None),
                  LeverConfig(ObjectPositionEnum.UPPER, LeverRoleEnum.inactive, None),
    ...
    'trial4'   : [LeverConfig(ObjectPositionEnum.UPPERRIGHT, LeverRoleEnum.l0, None),
                  LeverConfig(ObjectPositionEnum.UPPER, LeverRoleEnum.l2, None),
                  LeverConfig(ObjectPositionEnum.UPPERLEFT, LeverRoleEnum.l1, None),
                  LeverConfig(ObjectPositionEnum.LEFT, LeverRoleEnum.inactive, None),
                  LeverConfig(ObjectPositionEnum.LOWERLEFT, LeverRoleEnum.inactive, None),
    ...
    'trial5'   : [LeverConfig(ObjectPositionEnum.UPPERRIGHT, LeverRoleEnum.inactive, None),
                  LeverConfig(ObjectPositionEnum.UPPER, LeverRoleEnum.inactive, None),
                  LeverConfig(ObjectPositionEnum.UPPERLEFT, LeverRoleEnum.l2, None),
                  LeverConfig(ObjectPositionEnum.LEFT, LeverRoleEnum.l0, None),
                  LeverConfig(ObjectPositionEnum.LOWERLEFT, LeverRoleEnum.l1, None),
    ...
    'trial6'   : [LeverConfig(ObjectPositionEnum.UPPERRIGHT, LeverRoleEnum.inactive, None),
                  LeverConfig(ObjectPositionEnum.UPPER, LeverRoleEnum.inactive, None),
                  LeverConfig(ObjectPositionEnum.UPPERLEFT, LeverRoleEnum.inactive, None),
                  LeverConfig(ObjectPositionEnum.LEFT, LeverRoleEnum.inactive, None),
                  LeverConfig(ObjectPositionEnum.LOWERLEFT, LeverRoleEnum.l2, None),
    ...
    'trial7'   : [LeverConfig(ObjectPositionEnum.UPPERRIGHT, LeverRoleEnum.l1, None),
                  LeverConfig(ObjectPositionEnum.UPPER, LeverRoleEnum.inactive, None),
    ...
    'trial8'   : [LeverConfig(ObjectPositionEnum.UPPERRIGHT, LeverRoleEnum.l0, None),
    ...
    'trial9'   : [LeverConfig(ObjectPositionEnum.UPPERRIGHT, LeverRoleEnum.inactive, None),
                  LeverConfig(ObjectPositionEnum.UPPER, LeverRoleEnum.l1, None),
    ...
    'trial10'  : [LeverConfig(ObjectPositionEnum.UPPERRIGHT, LeverRoleEnum.inactive, None),
                  LeverConfig(ObjectPositionEnum.UPPER, LeverRoleEnum.inactive, None),
                  LeverConfig(ObjectPositionEnum.UPPERLEFT, LeverRoleEnum.l1, None),
                  LeverConfig(ObjectPositionEnum.LEFT, LeverRoleEnum.l2, None),
                  LeverConfig(ObjectPositionEnum.LOWERLEFT, LeverRoleEnum.l0, None),
    ...
    'trial11'  : [LeverConfig(ObjectPositionEnum.UPPERRIGHT, LeverRoleEnum.inactive, None),
                  LeverConfig(ObjectPositionEnum.UPPER, LeverRoleEnum.inactive, None),
                  LeverConfig(ObjectPositionEnum.UPPERLEFT, LeverRoleEnum.inactive, None),
    ...
    'multi-lock': [LeverConfig(ObjectPositionEnum.UPPERRIGHT, LeverRoleEnum.inactive, None),
                   LeverConfig(ObjectPositionEnum.UPPER, LeverRoleEnum.l2, None),
                   LeverConfig(ObjectPositionEnum.UPPERLEFT, LeverRoleEnum.inactive, None),
                   LeverConfig(ObjectPositionEnum.LEFT, LeverRoleEnum.l0, {'lower_lim': 0.0, 'upper_lim': 2.0}),
                   LeverConfig(ObjectPositionEnum.LOWERLEFT, LeverRoleEnum.inactive, None),
                   LeverConfig(ObjectPositionEnum.LOWER, LeverRoleEnum.l1, None),
                   LeverConfig(ObjectPositionEnum.LOWERRIGHT, LeverRoleEnum.inactive, None)],
    # full.
    'full'     : [LeverConfig(ObjectPositionEnum.UPPERRIGHT, LeverRoleEnum.l0, None),
                  LeverConfig(ObjectPositionEnum.UPPER, LeverRoleEnum.l1, None),
                  LeverConfig(ObjectPositionEnum.UPPERLEFT, LeverRoleEnum.l2, None),
                  LeverConfig(ObjectPositionEnum.LEFT, LeverRoleEnum.l3, None),
