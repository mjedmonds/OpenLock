...
class HumanAgent(Agent):
    ...
    def prompt_participant_id():
        while True:
            try:
                participant_id = int(input('Please enter the participant ID (ask the RA for this): '))
            except ValueError:
    ...
    def prompt_gender():
        while True:
            gender = input('Please enter your gender (\'M\' for male, \'F\' for female, or \'O\' for other): ')
    ...
    def prompt_handedness():
        while True:
            handedness = input('Please enter your handedness (\'right\' for right-handed or \'left\' for left-handed): ')
    ...
    def prompt_eyewear():
        while True:
            eyewear = input('Please enter \'yes\' if you wear glasses or contacts or \'no\' if you do not wear glasses or contacts: ')
    ...
    @staticmethod
    def prompt_strategy():
        strategy = input('Did you develop any particular technique or strategy to solve the problem? If so, what was your technique/strategy? ')
        return strategy

    @staticmethod
    def prompt_transfer_strategy():
        transfer_strategy = input('If you used a particular technique/strategy, did you find that it also worked when the number of colored levers increased from 3 to 4? ')
